      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-16 md:mb-20 max-w-4xl mx-auto leading-relaxed">qBTC is a Proof-of-Work sidechain that inherits Bitcoin's design while upgrading its cryptography to survive the first large-scale quantum computer.</p>
              ...
              >
                <Card className="glass-card p-8 rounded-2xl hover:shadow-lg hover:shadow-muted/10 transition-all duration-300 group h-full">
                  <CardContent className="p-0 flex flex-col h-full">
                    <div className="w-16 h-16 orange-gradient rounded-xl flex items-center justify-center group-hover:animate-glow">
                      <benefit.icon className="w-8 h-8 text-white" />
                    </div>
                    <h3 className="text-2xl font-bold mt-6 h-16">{benefit.title}</h3>
                    <div className="mt-4 h-28">
                      <p className="text-muted-foreground">{benefit.description}</p>
                    </div>
                    <div className="mt-4 bg-card border border-muted/30 p-4 rounded-lg font-mono text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">
              Institutional Grade <span className="text-primary">Cryptography</span>
            </h2>
